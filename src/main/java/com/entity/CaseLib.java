...
/**
 * SjCaseLib generated by hbm2java
 */
@Entity
@Table(name = "SJ_CASE_LIB", catalog = "sjtu_train")
public class CaseLib implements java.io.Serializable {
	...
	public CaseLib(String name, String libDesc, String organiCode,
