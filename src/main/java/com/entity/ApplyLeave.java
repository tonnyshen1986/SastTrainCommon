...
/**
 * SjApplyLeave generated by hbm2java
 */
@Entity
@Table(name = "SJ_APPLY_LEAVE", catalog = "sast_train")
public class ApplyLeave implements java.io.Serializable {
	...
	public ApplyLeave(String account, String certifiNo, Integer personType,Integer projectId, 
			Integer courseId, Integer approveResult, String askForLeaveReason,
	...
	@Column(name = "ASK_FOR_LEAVE_REASON")
