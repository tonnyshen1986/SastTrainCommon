...
/**
 * SjDicEmployeeType generated by hbm2java
 */
@Entity
@Table(name = "SJ_DIC_EMPLOYEE_TYPE", catalog = "sast_train")
public class DicEmployeeType implements java.io.Serializable {
	...
	public DicEmployeeType() {
	}

	public DicEmployeeType(String name, String employeeTypeDesc,
